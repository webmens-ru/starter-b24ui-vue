...
import { getNextPage, getPrevPage, type Type6NavState } from './type6Navigation'

function state(overrides: Partial<Type6NavState> = {}): Type6NavState {
  return {
    modelId: '6',
    materialFacadeGlob: 'Жалюзи',
...
describe('type6Navigation', () => {
  describe('getNextPage', () => {
    it('page2 → page2_facade_zhalyuzi', () => {
      expect(getNextPage('page2', state())).toBe('page2_facade_zhalyuzi')
    })
    it('page2_facade_zhalyuzi → page5 (всегда одна сторона)', () => {
      expect(getNextPage('page2_facade_zhalyuzi', state())).toBe('page5')
    })
  ...
  describe('getPrevPage', () => {
    it('page2_facade_zhalyuzi → page2', () => {
      expect(getPrevPage('page2_facade_zhalyuzi', state())).toBe('page2')
    })
    it('page5 → page2_facade_zhalyuzi', () => {
      expect(getPrevPage('page5', state())).toBe('page2_facade_zhalyuzi')
    })
