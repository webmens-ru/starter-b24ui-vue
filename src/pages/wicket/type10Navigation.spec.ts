...
import { getNextPage, getPrevPage, type type10NavState } from './type10Navigation'

function state(overrides: Partial<type10NavState> = {}): type10NavState {
  return {
    modelId: '10',
