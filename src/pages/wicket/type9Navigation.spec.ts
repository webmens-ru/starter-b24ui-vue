...
import { getNextPage, getPrevPage, type Type9NavState } from './type9Navigation'

function state(overrides: Partial<Type9NavState> = {}): Type9NavState {
  return {
    modelId: '9',
